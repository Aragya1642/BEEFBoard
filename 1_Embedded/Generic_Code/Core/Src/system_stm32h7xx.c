...
/* Relocated to 0x08020000: this app runs above the OpenBLT bootloader, not at
   the flash base, so the vector table must be moved to match (see VECT_TAB_OFFSET). */
...
#define VECT_TAB_OFFSET         0x00020000U       /*!< Vector Table base offset field.
                                                       Matches the app's 0x08020000 load
                                                       address (FLASH_BANK1_BASE + 0x20000),
                                                       i.e. just above the OpenBLT bootloader.
                                                       This value must be a multiple of 0x400. */
